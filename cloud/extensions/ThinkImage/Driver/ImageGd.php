...
namespace cloud\extensions\ThinkImage\Driver;
...
class ImageGd {
    ...
    public function open( $imgname ) {
        ...
        if ( 'gif' == $this->info['type'] ) {
            ...
            if ( !LOCAL ) {
                $imgname = Cloud::engine()->io()->file()->fetchTemp( File::fileName( $imgname ), $this->info['type'] );
            }
    ...
    public function save( $imgname, $type = null, $interlace = true ) {
        ...
        if ( 'gif' == $type && !empty( $this->gif ) ) {
            ...
            $fun = "image{$type}";
            if ( !LOCAL ) {
                $temp = Cloud::engine()->io()->file()->fetchTemp( File::fileName( $imgname ), $this->info['type'] );
                $fun( $this->img, $temp );
                $content = file_get_contents( $temp );
                Cloud::engine()->io()->file()->writeFile( $imgname, $content );
            } else {
