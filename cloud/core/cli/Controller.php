...
abstract class Controller  extends CComponent
{
     ...
     * @param Runner $runner the command runner
     */
    ...
    protected function beforeAction($action,$params)
    {
        ...
        {
            $event = new Event($this,$params,$action);
    ...
    {
        $event=new Event($this,$params,$action,$exitCode);
    ...
    /**
     * @return Runner the command runner instance
     */
