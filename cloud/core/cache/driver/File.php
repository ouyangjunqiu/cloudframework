...
namespace cloud\core\cache\driver;

use cloud\Cloud;
use cloud\core\components\Cache;
...
class File extends Cache {
	...
	public function __construct( $options = array() ) {
		...
		$this->options['temp'] = !empty( $options['temp'] ) ? $options['temp'] : Cloud::app()->getRuntimePath() . DIRECTORY_SEPARATOR . 'cache';
