...
namespace cloud\extensions\ThinkImage;


use cloud\extensions\ThinkImage\Driver\ImageGd;
use cloud\extensions\ThinkImage\Driver\ImageImagick;
use Exception;
...
class ThinkImage {
    ...
    /**
     * 图片资源
     * @var resource|ImageGd|ImageImagick
     */
    private $img;

    /**
     * 构造方法，用于实例化一个图片处理对象
     * @param string|int $type 要使用的类库，默认使用GD库
    ...
    public function __construct( $type = THINKIMAGE_GD, $imgname = null ) {
        ...
        switch ( $type ) {
            case THINKIMAGE_GD:
                $class = 'cloud\extensions\ThinkImage\Driver\ImageGd';
                break;
            case THINKIMAGE_IMAGICK:
                $class = 'cloud\extensions\ThinkImage\Driver\ImageImagick';
                break;
            default:
